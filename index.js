...
const config = {
    RBS: '👾RIBASBOT👾',
    instagram: 'https://instagram.com/_t4be5enior._',
    nomer: 'wa.me/6282193030283',
    aktif: '24 JAM',
    youtube: 'https://youtube.com/channel/UCVoeo63MfuTBPXlbj-ldX3Q',
    whatsapp: 'https://api.whatsapp.com/send?phone=6282193030283',
    tanggal: `TANGGAL: ${moment().format('DD')} ${bulan} ${moment().format('YYYY')}`,
    waktu: time
}

const { RBS, tanggal, waktu, instagram, whatsapp, youtube, nomer, aktif, ontime } = config
...
client.on('message-new', async (m) => {
   ...
   switch (prefix) {
       case 'help':
           client.sendMessage(id, help.help(id, RSBT, tanggal, whatsapp, youtube, instagram, nomer),MessageType.text)
           break      
      case 'donate':
           client.sendMessage(id, donate.donate(id, RSBT, tanggal),MessageType.text)
           break          
      case 'info':
           client.sendMessage(id, info.info(id, RSBT, tanggal),MessageType.text)
           break             
       case 'nulis':
           nulis(value)
               .then(data => {
